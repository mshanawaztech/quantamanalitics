...
| #   | Branch                          | Scope                                                                          | Status |
| --- | ------------------------------- | ------------------------------------------------------------------------------ | ------ |
| 01  | `qa001-bootstrap`               | README, CLAUDE.md, plan, conventions, gitignore, PR template, .claude/ folder  | in progress |
| 02  | `qa001-solution-scaffold`       | ASP.NET Core 10 solution + Angular workspace + `/health` endpoint              | pending |
