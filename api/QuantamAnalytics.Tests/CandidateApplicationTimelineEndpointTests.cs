...
public sealed class CandidateApplicationTimelineEndpointTests : IClassFixture<WebApplicationFactory<Program>>
{
    private readonly WebApplicationFactory<Program> _factory;

    public CandidateApplicationTimelineEndpointTests(WebApplicationFactory<Program> factory)
    {
        _factory = factory;
    }
