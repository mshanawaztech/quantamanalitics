...
public sealed class CandidateApplicationsEndpointTests : IClassFixture<WebApplicationFactory<Program>>
{
    private readonly WebApplicationFactory<Program> _factory;

    public CandidateApplicationsEndpointTests(WebApplicationFactory<Program> factory)
    {
        _factory = factory;
    }
