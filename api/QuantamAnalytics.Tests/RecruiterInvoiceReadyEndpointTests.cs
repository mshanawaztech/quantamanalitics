...
public sealed class RecruiterInvoiceReadyEndpointTests : IClassFixture<WebApplicationFactory<Program>>
{
    private readonly WebApplicationFactory<Program> _factory;

    public RecruiterInvoiceReadyEndpointTests(WebApplicationFactory<Program> factory)
    {
        _factory = factory;
    }
